...
describe('JAVASCRIPT II', function () {
   ...
   describe('conection(status)', function () {
      it('Debe retornar el estado de conexión del usuario', function () {
   ...
   describe('esEntero(num)', function () {
      it('Debe retornar true si num es 5', function () {
   ...
   describe('operadoresLogicos(num1, num2, num3)', function () {
      it("Debe retornar 'Número 1 es mayor y positivo' si num1 es positivo y mayor que num2 y num3", function () {
